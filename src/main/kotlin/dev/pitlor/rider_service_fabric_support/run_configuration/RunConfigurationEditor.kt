...
class RunConfigurationEditor(project: Project) : SettingsEditor<RunConfiguration>() {
    ...
    override fun resetEditorFrom(runConfiguration: RunConfiguration) {
        sfprojFolder.text = runConfiguration.sfProjFolder.getTildePath()
        publishProfile.item = runConfiguration.publishProfile
    }

    override fun applyEditorTo(runConfiguration: RunConfiguration) {
        runConfiguration.sfProjFolder = Utils.findFile(sfprojFolder.text)!!
        runConfiguration.publishProfile = publishProfile.item
    }
