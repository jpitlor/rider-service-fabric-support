...
@Fluent
public final class RestartPartitionResult {
    /*
     ...
     */
    public RestartPartitionResult setErrorCode(Integer errorCode) {
     ...
     * @return the RestartPartitionResult object itself.
     */
    public RestartPartitionResult setSelectedPartition(SelectedPartition selectedPartition) {
