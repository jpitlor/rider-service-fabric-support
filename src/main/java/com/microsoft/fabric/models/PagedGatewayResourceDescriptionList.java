...
/**
 * The list of gateway resources. The list is paged when all of the results cannot fit in a single message. The next set
 * of results can be obtained by executing the same query with the continuation token provided in this list.
 */
@Fluent
public final class PagedGatewayResourceDescriptionList {
    /*
    ...
    private List<GatewayResourceDescription> items;
     ...
     * @return the PagedGatewayResourceDescriptionList object itself.
     */
    public PagedGatewayResourceDescriptionList setContinuationToken(String continuationToken) {
     ...
     * @return the PagedGatewayResourceDescriptionList object itself.
     */
    public PagedGatewayResourceDescriptionList setItems(List<GatewayResourceDescription> items) {
        this.items = items;
        return this;
    }
}
