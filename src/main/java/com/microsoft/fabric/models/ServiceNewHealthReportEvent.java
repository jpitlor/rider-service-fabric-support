...
@JsonTypeName("ServiceNewHealthReport")
@Fluent
public final class ServiceNewHealthReportEvent extends ServiceEvent {
    /*
    ...
    /**
     * Get the instanceId property: Id of Service instance.
     *
    ...
    /**
     * Set the instanceId property: Id of Service instance.
     *
     * @param instanceId the instanceId value to set.
     * @return the ServiceNewHealthReportEvent object itself.
     */
    public ServiceNewHealthReportEvent setInstanceId(long instanceId) {
     ...
     * @return the ServiceNewHealthReportEvent object itself.
     */
    public ServiceNewHealthReportEvent setSourceId(String sourceId) {
     ...
     * @return the ServiceNewHealthReportEvent object itself.
     */
    public ServiceNewHealthReportEvent setProperty(String property) {
     ...
     * @return the ServiceNewHealthReportEvent object itself.
     */
    public ServiceNewHealthReportEvent setHealthState(String healthState) {
     ...
     * @return the ServiceNewHealthReportEvent object itself.
     */
    public ServiceNewHealthReportEvent setTimeToLiveMs(long timeToLiveMs) {
     ...
     * @return the ServiceNewHealthReportEvent object itself.
     */
    public ServiceNewHealthReportEvent setSequenceNumber(long sequenceNumber) {
     ...
     * @return the ServiceNewHealthReportEvent object itself.
     */
    public ServiceNewHealthReportEvent setDescription(String description) {
     ...
     * @return the ServiceNewHealthReportEvent object itself.
     */
    public ServiceNewHealthReportEvent setRemoveWhenExpired(boolean removeWhenExpired) {
     ...
     * @return the ServiceNewHealthReportEvent object itself.
     */
    public ServiceNewHealthReportEvent setSourceUtcTimestamp(OffsetDateTime sourceUtcTimestamp) {
