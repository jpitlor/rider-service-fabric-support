...
@Fluent
public final class StatefulReplicaHealthReportExpiredEvent extends ReplicaEvent {
    /*
     ...
     */
    public StatefulReplicaHealthReportExpiredEvent setReplicaInstanceId(long replicaInstanceId) {
     ...
     * @return the StatefulReplicaHealthReportExpiredEvent object itself.
     */
    public StatefulReplicaHealthReportExpiredEvent setSourceId(String sourceId) {
     ...
     * @return the StatefulReplicaHealthReportExpiredEvent object itself.
     */
    public StatefulReplicaHealthReportExpiredEvent setProperty(String property) {
     ...
     * @return the StatefulReplicaHealthReportExpiredEvent object itself.
     */
    public StatefulReplicaHealthReportExpiredEvent setHealthState(String healthState) {
     ...
     * @return the StatefulReplicaHealthReportExpiredEvent object itself.
     */
    public StatefulReplicaHealthReportExpiredEvent setTimeToLiveMs(long timeToLiveMs) {
     ...
     * @return the StatefulReplicaHealthReportExpiredEvent object itself.
     */
    public StatefulReplicaHealthReportExpiredEvent setSequenceNumber(long sequenceNumber) {
     ...
     * @return the StatefulReplicaHealthReportExpiredEvent object itself.
     */
    public StatefulReplicaHealthReportExpiredEvent setDescription(String description) {
     ...
     * @return the StatefulReplicaHealthReportExpiredEvent object itself.
     */
    public StatefulReplicaHealthReportExpiredEvent setRemoveWhenExpired(boolean removeWhenExpired) {
     ...
     * @return the StatefulReplicaHealthReportExpiredEvent object itself.
     */
    public StatefulReplicaHealthReportExpiredEvent setSourceUtcTimestamp(OffsetDateTime sourceUtcTimestamp) {
