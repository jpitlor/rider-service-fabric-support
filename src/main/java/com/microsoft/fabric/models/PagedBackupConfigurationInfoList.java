...
/**
 * The list of backup configuration information. The list is paged when all of the results cannot fit in a single
 * message. The next set of results can be obtained by executing the same query with the continuation token provided in
 * this list.
 */
@Fluent
public final class PagedBackupConfigurationInfoList {
    /*
     ...
     * @return the PagedBackupConfigurationInfoList object itself.
     */
    public PagedBackupConfigurationInfoList setContinuationToken(String continuationToken) {
        this.continuationToken = continuationToken;
        return this;
    }

    /**
     * Get the items property: List of backup configuration information.
     *
     * @return the items value.
     */
    public List<BackupConfigurationInfo> getItems() {
        return this.items;
    }

    /**
     * Set the items property: List of backup configuration information.
     *
     * @param items the items value to set.
     * @return the PagedBackupConfigurationInfoList object itself.
     */
    public PagedBackupConfigurationInfoList setItems(List<BackupConfigurationInfo> items) {
        this.items = items;
        return this;
    }
}
