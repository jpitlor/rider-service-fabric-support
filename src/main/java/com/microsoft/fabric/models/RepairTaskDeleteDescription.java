 ...
 */
@Fluent
public final class RepairTaskDeleteDescription {
    /*
    ...
    /**
     * Get the taskId property: The ID of the completed repair task to be deleted.
     *
    ...
    /**
     * Set the taskId property: The ID of the completed repair task to be deleted.
     *
     * @param taskId the taskId value to set.
     * @return the RepairTaskDeleteDescription object itself.
     */
    public RepairTaskDeleteDescription setTaskId(String taskId) {
        this.taskId = taskId;
        return this;
    }
     ...
     * @return the RepairTaskDeleteDescription object itself.
     */
    public RepairTaskDeleteDescription setVersion(String version) {
