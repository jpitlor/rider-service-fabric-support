...
/**
 * The list of deployed applications in activating, downloading, or active states on a node. The list is paged when all
 * of the results cannot fit in a single message. The next set of results can be obtained by executing the same query
 * with the continuation token provided in this list.
 */
@Fluent
public final class PagedDeployedApplicationInfoList {
    /*
    ...
    private List<DeployedApplicationInfo> items;
     ...
     * @return the PagedDeployedApplicationInfoList object itself.
     */
    public PagedDeployedApplicationInfoList setContinuationToken(String continuationToken) {
        this.continuationToken = continuationToken;
        return this;
    }

    /**
     * Get the items property: List of deployed application information.
     *
    ...
    /**
     * Set the items property: List of deployed application information.
     *
     * @param items the items value to set.
     * @return the PagedDeployedApplicationInfoList object itself.
     */
    public PagedDeployedApplicationInfoList setItems(List<DeployedApplicationInfo> items) {
        this.items = items;
        return this;
    }
}
