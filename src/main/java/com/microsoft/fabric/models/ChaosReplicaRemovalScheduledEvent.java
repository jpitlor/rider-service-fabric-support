...
@JsonTypeName("ChaosReplicaRemovalScheduled")
@Fluent
public final class ChaosReplicaRemovalScheduledEvent extends ReplicaEvent {
    /*
     * Id of fault group.
     */
     ...
     * @return the ChaosReplicaRemovalScheduledEvent object itself.
     */
    public ChaosReplicaRemovalScheduledEvent setFaultGroupId(UUID faultGroupId) {
     ...
     * @return the ChaosReplicaRemovalScheduledEvent object itself.
     */
    public ChaosReplicaRemovalScheduledEvent setFaultId(UUID faultId) {
     ...
     * @return the ChaosReplicaRemovalScheduledEvent object itself.
     */
    public ChaosReplicaRemovalScheduledEvent setServiceUri(String serviceUri) {
