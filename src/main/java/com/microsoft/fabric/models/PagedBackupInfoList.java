...
/**
 * The list of backups. The list is paged when all of the results cannot fit in a single message. The next set of
 * results can be obtained by executing the same query with the continuation token provided in this list.
 */
@Fluent
public final class PagedBackupInfoList {
    /*
     ...
     * @return the PagedBackupInfoList object itself.
     */
    public PagedBackupInfoList setContinuationToken(String continuationToken) {
        this.continuationToken = continuationToken;
        return this;
    }

    /**
     * Get the items property: List of backup information.
     *
    ...
    /**
     * Set the items property: List of backup information.
     *
     * @param items the items value to set.
     * @return the PagedBackupInfoList object itself.
     */
    public PagedBackupInfoList setItems(List<BackupInfo> items) {
        this.items = items;
        return this;
    }
}
