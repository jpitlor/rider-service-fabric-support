...
@Fluent
public final class PartitionHealthReportExpiredEvent extends PartitionEvent {
    /*
     * Id of report source.
     */
     ...
     */
    public PartitionHealthReportExpiredEvent setSourceId(String sourceId) {
     ...
     * @return the PartitionHealthReportExpiredEvent object itself.
     */
    public PartitionHealthReportExpiredEvent setProperty(String property) {
     ...
     * @return the PartitionHealthReportExpiredEvent object itself.
     */
    public PartitionHealthReportExpiredEvent setHealthState(String healthState) {
     ...
     * @return the PartitionHealthReportExpiredEvent object itself.
     */
    public PartitionHealthReportExpiredEvent setTimeToLiveMs(long timeToLiveMs) {
     ...
     * @return the PartitionHealthReportExpiredEvent object itself.
     */
    public PartitionHealthReportExpiredEvent setSequenceNumber(long sequenceNumber) {
     ...
     * @return the PartitionHealthReportExpiredEvent object itself.
     */
    public PartitionHealthReportExpiredEvent setDescription(String description) {
     ...
     * @return the PartitionHealthReportExpiredEvent object itself.
     */
    public PartitionHealthReportExpiredEvent setRemoveWhenExpired(boolean removeWhenExpired) {
     ...
     * @return the PartitionHealthReportExpiredEvent object itself.
     */
    public PartitionHealthReportExpiredEvent setSourceUtcTimestamp(OffsetDateTime sourceUtcTimestamp) {
