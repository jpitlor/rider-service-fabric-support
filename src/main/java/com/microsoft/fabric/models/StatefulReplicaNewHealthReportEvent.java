...
@JsonTypeName("StatefulReplicaNewHealthReport")
@Fluent
public final class StatefulReplicaNewHealthReportEvent extends ReplicaEvent {
    /*
    ...
    /**
     * Get the replicaInstanceId property: Id of Replica instance.
     *
    ...
    /**
     * Set the replicaInstanceId property: Id of Replica instance.
     *
     * @param replicaInstanceId the replicaInstanceId value to set.
     * @return the StatefulReplicaNewHealthReportEvent object itself.
     */
    public StatefulReplicaNewHealthReportEvent setReplicaInstanceId(long replicaInstanceId) {
     ...
     * @return the StatefulReplicaNewHealthReportEvent object itself.
     */
    public StatefulReplicaNewHealthReportEvent setSourceId(String sourceId) {
     ...
     * @return the StatefulReplicaNewHealthReportEvent object itself.
     */
    public StatefulReplicaNewHealthReportEvent setProperty(String property) {
     ...
     * @return the StatefulReplicaNewHealthReportEvent object itself.
     */
    public StatefulReplicaNewHealthReportEvent setHealthState(String healthState) {
     ...
     * @return the StatefulReplicaNewHealthReportEvent object itself.
     */
    public StatefulReplicaNewHealthReportEvent setTimeToLiveMs(long timeToLiveMs) {
     ...
     * @return the StatefulReplicaNewHealthReportEvent object itself.
     */
    public StatefulReplicaNewHealthReportEvent setSequenceNumber(long sequenceNumber) {
     ...
     * @return the StatefulReplicaNewHealthReportEvent object itself.
     */
    public StatefulReplicaNewHealthReportEvent setDescription(String description) {
     ...
     * @return the StatefulReplicaNewHealthReportEvent object itself.
     */
    public StatefulReplicaNewHealthReportEvent setRemoveWhenExpired(boolean removeWhenExpired) {
     ...
     * @return the StatefulReplicaNewHealthReportEvent object itself.
     */
    public StatefulReplicaNewHealthReportEvent setSourceUtcTimestamp(OffsetDateTime sourceUtcTimestamp) {
