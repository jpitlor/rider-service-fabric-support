...
/**
 * The list of application types that are provisioned or being provisioned in the cluster. The list is paged when all of
 ...
 */
@Fluent
public final class PagedApplicationTypeInfoList {
    /*
     ...
     * @return the PagedApplicationTypeInfoList object itself.
     */
    public PagedApplicationTypeInfoList setContinuationToken(String continuationToken) {
        this.continuationToken = continuationToken;
        return this;
    }

    /**
     * Get the items property: List of application type information.
     *
    ...
    /**
     * Set the items property: List of application type information.
     *
     * @param items the items value to set.
     * @return the PagedApplicationTypeInfoList object itself.
     */
    public PagedApplicationTypeInfoList setItems(List<ApplicationTypeInfo> items) {
        this.items = items;
        return this;
    }
}
