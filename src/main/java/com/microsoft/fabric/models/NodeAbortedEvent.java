...
@JsonTypeName("NodeAborted")
@Fluent
public final class NodeAbortedEvent extends NodeEvent {
    /*
     * Id of Node instance.
     */
     ...
     * @return the NodeAbortedEvent object itself.
     */
    public NodeAbortedEvent setNodeInstance(long nodeInstance) {
     ...
     * @return the NodeAbortedEvent object itself.
     */
    public NodeAbortedEvent setNodeId(String nodeId) {
        this.nodeId = nodeId;
        return this;
    }
     ...
     * @return the NodeAbortedEvent object itself.
     */
    public NodeAbortedEvent setUpgradeDomain(String upgradeDomain) {
     ...
     * @return the NodeAbortedEvent object itself.
     */
    public NodeAbortedEvent setFaultDomain(String faultDomain) {
     ...
     * @return the NodeAbortedEvent object itself.
     */
    public NodeAbortedEvent setIpAddressOrFqdn(String ipAddressOrFqdn) {
     ...
     * @return the NodeAbortedEvent object itself.
     */
    public NodeAbortedEvent setHostname(String hostname) {
     ...
     * @return the NodeAbortedEvent object itself.
     */
    public NodeAbortedEvent setIsSeedNode(boolean isSeedNode) {
     ...
     * @return the NodeAbortedEvent object itself.
     */
    public NodeAbortedEvent setNodeVersion(String nodeVersion) {
