...
@JsonTypeName("ApplicationHealthReportExpired")
@Fluent
public final class ApplicationHealthReportExpiredEvent extends ApplicationEvent {
    /*
     ...
     * @return the ApplicationHealthReportExpiredEvent object itself.
     */
    public ApplicationHealthReportExpiredEvent setApplicationInstanceId(long applicationInstanceId) {
     ...
     * @return the ApplicationHealthReportExpiredEvent object itself.
     */
    public ApplicationHealthReportExpiredEvent setSourceId(String sourceId) {
     ...
     * @return the ApplicationHealthReportExpiredEvent object itself.
     */
    public ApplicationHealthReportExpiredEvent setProperty(String property) {
     ...
     * @return the ApplicationHealthReportExpiredEvent object itself.
     */
    public ApplicationHealthReportExpiredEvent setHealthState(String healthState) {
     ...
     * @return the ApplicationHealthReportExpiredEvent object itself.
     */
    public ApplicationHealthReportExpiredEvent setTimeToLiveMs(long timeToLiveMs) {
     ...
     * @return the ApplicationHealthReportExpiredEvent object itself.
     */
    public ApplicationHealthReportExpiredEvent setSequenceNumber(long sequenceNumber) {
     ...
     * @return the ApplicationHealthReportExpiredEvent object itself.
     */
    public ApplicationHealthReportExpiredEvent setDescription(String description) {
     ...
     * @return the ApplicationHealthReportExpiredEvent object itself.
     */
    public ApplicationHealthReportExpiredEvent setRemoveWhenExpired(boolean removeWhenExpired) {
     ...
     * @return the ApplicationHealthReportExpiredEvent object itself.
     */
    public ApplicationHealthReportExpiredEvent setSourceUtcTimestamp(OffsetDateTime sourceUtcTimestamp) {
