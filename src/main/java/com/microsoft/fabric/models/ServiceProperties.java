...
public class ServiceProperties {
     ...
     */
    public ServiceProperties setDescription(String description) {
     ...
     * @return the ServiceProperties object itself.
     */
    public ServiceProperties setReplicaCount(Integer replicaCount) {
     ...
     * @return the ServiceProperties object itself.
     */
    public ServiceProperties setExecutionPolicy(ExecutionPolicy executionPolicy) {
     ...
     * @return the ServiceProperties object itself.
     */
    public ServiceProperties setAutoScalingPolicies(List<AutoScalingPolicy> autoScalingPolicies) {
     ...
     * @return the ServiceProperties object itself.
     */
    public ServiceProperties setIdentityRefs(List<ServiceIdentity> identityRefs) {
     ...
     * @return the ServiceProperties object itself.
     */
    public ServiceProperties setDnsName(String dnsName) {
