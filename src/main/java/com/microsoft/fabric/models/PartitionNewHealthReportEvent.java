...
@JsonTypeName("PartitionNewHealthReport")
@Fluent
public final class PartitionNewHealthReportEvent extends PartitionEvent {
    /*
     * Id of report source.
     */
     ...
     * @return the PartitionNewHealthReportEvent object itself.
     */
    public PartitionNewHealthReportEvent setSourceId(String sourceId) {
     ...
     * @return the PartitionNewHealthReportEvent object itself.
     */
    public PartitionNewHealthReportEvent setProperty(String property) {
     ...
     * @return the PartitionNewHealthReportEvent object itself.
     */
    public PartitionNewHealthReportEvent setHealthState(String healthState) {
     ...
     * @return the PartitionNewHealthReportEvent object itself.
     */
    public PartitionNewHealthReportEvent setTimeToLiveMs(long timeToLiveMs) {
     ...
     * @return the PartitionNewHealthReportEvent object itself.
     */
    public PartitionNewHealthReportEvent setSequenceNumber(long sequenceNumber) {
     ...
     * @return the PartitionNewHealthReportEvent object itself.
     */
    public PartitionNewHealthReportEvent setDescription(String description) {
     ...
     * @return the PartitionNewHealthReportEvent object itself.
     */
    public PartitionNewHealthReportEvent setRemoveWhenExpired(boolean removeWhenExpired) {
     ...
     * @return the PartitionNewHealthReportEvent object itself.
     */
    public PartitionNewHealthReportEvent setSourceUtcTimestamp(OffsetDateTime sourceUtcTimestamp) {
