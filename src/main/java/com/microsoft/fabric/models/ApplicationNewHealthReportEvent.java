...
@Fluent
public final class ApplicationNewHealthReportEvent extends ApplicationEvent {
    /*
     ...
     */
    public ApplicationNewHealthReportEvent setApplicationInstanceId(long applicationInstanceId) {
     ...
     * @return the ApplicationNewHealthReportEvent object itself.
     */
    public ApplicationNewHealthReportEvent setSourceId(String sourceId) {
     ...
     * @return the ApplicationNewHealthReportEvent object itself.
     */
    public ApplicationNewHealthReportEvent setProperty(String property) {
     ...
     * @return the ApplicationNewHealthReportEvent object itself.
     */
    public ApplicationNewHealthReportEvent setHealthState(String healthState) {
     ...
     * @return the ApplicationNewHealthReportEvent object itself.
     */
    public ApplicationNewHealthReportEvent setTimeToLiveMs(long timeToLiveMs) {
     ...
     * @return the ApplicationNewHealthReportEvent object itself.
     */
    public ApplicationNewHealthReportEvent setSequenceNumber(long sequenceNumber) {
     ...
     * @return the ApplicationNewHealthReportEvent object itself.
     */
    public ApplicationNewHealthReportEvent setDescription(String description) {
     ...
     * @return the ApplicationNewHealthReportEvent object itself.
     */
    public ApplicationNewHealthReportEvent setRemoveWhenExpired(boolean removeWhenExpired) {
     ...
     * @return the ApplicationNewHealthReportEvent object itself.
     */
    public ApplicationNewHealthReportEvent setSourceUtcTimestamp(OffsetDateTime sourceUtcTimestamp) {
