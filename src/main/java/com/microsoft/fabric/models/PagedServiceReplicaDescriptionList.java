...
/**
 * The list of service resource replicas in the cluster. The list is paged when all of the results cannot fit in a
 ...
 */
@Fluent
public final class PagedServiceReplicaDescriptionList {
    /*
    ...
    private List<ServiceReplicaDescription> items;
     ...
     * @return the PagedServiceReplicaDescriptionList object itself.
     */
    public PagedServiceReplicaDescriptionList setContinuationToken(String continuationToken) {
        this.continuationToken = continuationToken;
        return this;
    }

    /**
     * Get the items property: List of service resource replica description.
     *
    ...
    /**
     * Set the items property: List of service resource replica description.
     *
     * @param items the items value to set.
     * @return the PagedServiceReplicaDescriptionList object itself.
     */
    public PagedServiceReplicaDescriptionList setItems(List<ServiceReplicaDescription> items) {
        this.items = items;
        return this;
    }
}
