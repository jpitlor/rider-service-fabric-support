...
/**
 * The list of volume resources. The list is paged when all of the results cannot fit in a single message. The next set
 * of results can be obtained by executing the same query with the continuation token provided in this list.
 */
@Fluent
public final class PagedVolumeResourceDescriptionList {
    /*
    ...
    private List<VolumeResourceDescription> items;
     ...
     * @return the PagedVolumeResourceDescriptionList object itself.
     */
    public PagedVolumeResourceDescriptionList setContinuationToken(String continuationToken) {
     ...
     * @return the PagedVolumeResourceDescriptionList object itself.
     */
    public PagedVolumeResourceDescriptionList setItems(List<VolumeResourceDescription> items) {
        this.items = items;
        return this;
    }
}
