...
@Fluent
public final class ServiceHealthReportExpiredEvent extends ServiceEvent {
    /*
     ...
     */
    public ServiceHealthReportExpiredEvent setInstanceId(long instanceId) {
     ...
     * @return the ServiceHealthReportExpiredEvent object itself.
     */
    public ServiceHealthReportExpiredEvent setSourceId(String sourceId) {
     ...
     * @return the ServiceHealthReportExpiredEvent object itself.
     */
    public ServiceHealthReportExpiredEvent setProperty(String property) {
     ...
     * @return the ServiceHealthReportExpiredEvent object itself.
     */
    public ServiceHealthReportExpiredEvent setHealthState(String healthState) {
     ...
     * @return the ServiceHealthReportExpiredEvent object itself.
     */
    public ServiceHealthReportExpiredEvent setTimeToLiveMs(long timeToLiveMs) {
     ...
     * @return the ServiceHealthReportExpiredEvent object itself.
     */
    public ServiceHealthReportExpiredEvent setSequenceNumber(long sequenceNumber) {
     ...
     * @return the ServiceHealthReportExpiredEvent object itself.
     */
    public ServiceHealthReportExpiredEvent setDescription(String description) {
     ...
     * @return the ServiceHealthReportExpiredEvent object itself.
     */
    public ServiceHealthReportExpiredEvent setRemoveWhenExpired(boolean removeWhenExpired) {
     ...
     * @return the ServiceHealthReportExpiredEvent object itself.
     */
    public ServiceHealthReportExpiredEvent setSourceUtcTimestamp(OffsetDateTime sourceUtcTimestamp) {
