...
@Fluent
public final class NodeHealthReportExpiredEvent extends NodeEvent {
    /*
     * Id of Node instance.
     */
     ...
     */
    public NodeHealthReportExpiredEvent setNodeInstanceId(long nodeInstanceId) {
     ...
     * @return the NodeHealthReportExpiredEvent object itself.
     */
    public NodeHealthReportExpiredEvent setSourceId(String sourceId) {
     ...
     * @return the NodeHealthReportExpiredEvent object itself.
     */
    public NodeHealthReportExpiredEvent setProperty(String property) {
     ...
     * @return the NodeHealthReportExpiredEvent object itself.
     */
    public NodeHealthReportExpiredEvent setHealthState(String healthState) {
     ...
     * @return the NodeHealthReportExpiredEvent object itself.
     */
    public NodeHealthReportExpiredEvent setTimeToLiveMs(long timeToLiveMs) {
     ...
     * @return the NodeHealthReportExpiredEvent object itself.
     */
    public NodeHealthReportExpiredEvent setSequenceNumber(long sequenceNumber) {
     ...
     * @return the NodeHealthReportExpiredEvent object itself.
     */
    public NodeHealthReportExpiredEvent setDescription(String description) {
     ...
     * @return the NodeHealthReportExpiredEvent object itself.
     */
    public NodeHealthReportExpiredEvent setRemoveWhenExpired(boolean removeWhenExpired) {
     ...
     * @return the NodeHealthReportExpiredEvent object itself.
     */
    public NodeHealthReportExpiredEvent setSourceUtcTimestamp(OffsetDateTime sourceUtcTimestamp) {
