...
/**
 * The list of secret resources. The list is paged when all of the results cannot fit in a single message. The next set
 * of results can be obtained by executing the same query with the continuation token provided in this list.
 */
@Fluent
public final class PagedSecretResourceDescriptionList {
    /*
    ...
    private List<SecretResourceDescription> items;
     ...
     * @return the PagedSecretResourceDescriptionList object itself.
     */
    public PagedSecretResourceDescriptionList setContinuationToken(String continuationToken) {
     ...
     */
    public List<SecretResourceDescription> getItems() {
        return this.items;
    }
     ...
     * @return the PagedSecretResourceDescriptionList object itself.
     */
    public PagedSecretResourceDescriptionList setItems(List<SecretResourceDescription> items) {
        this.items = items;
        return this;
    }
}
