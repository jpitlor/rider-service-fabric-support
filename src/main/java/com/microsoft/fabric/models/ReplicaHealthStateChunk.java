...
/**
 * Represents the health state chunk of a stateful service replica or a stateless service instance. The replica health
 * state contains the replica ID and its aggregated health state.
 */
@Fluent
public final class ReplicaHealthStateChunk extends EntityHealthStateChunk {
    /*
     ...
     */
    public ReplicaHealthStateChunk setReplicaOrInstanceId(String replicaOrInstanceId) {
