...
@JsonTypeName("ClusterNewHealthReport")
@Fluent
public final class ClusterNewHealthReportEvent extends ClusterEvent {
    /*
     * Id of report source.
     */
     ...
     * @return the ClusterNewHealthReportEvent object itself.
     */
    public ClusterNewHealthReportEvent setSourceId(String sourceId) {
     ...
     * @return the ClusterNewHealthReportEvent object itself.
     */
    public ClusterNewHealthReportEvent setProperty(String property) {
     ...
     * @return the ClusterNewHealthReportEvent object itself.
     */
    public ClusterNewHealthReportEvent setHealthState(String healthState) {
     ...
     * @return the ClusterNewHealthReportEvent object itself.
     */
    public ClusterNewHealthReportEvent setTimeToLiveMs(long timeToLiveMs) {
     ...
     * @return the ClusterNewHealthReportEvent object itself.
     */
    public ClusterNewHealthReportEvent setSequenceNumber(long sequenceNumber) {
     ...
     * @return the ClusterNewHealthReportEvent object itself.
     */
    public ClusterNewHealthReportEvent setDescription(String description) {
     ...
     * @return the ClusterNewHealthReportEvent object itself.
     */
    public ClusterNewHealthReportEvent setRemoveWhenExpired(boolean removeWhenExpired) {
     ...
     * @return the ClusterNewHealthReportEvent object itself.
     */
    public ClusterNewHealthReportEvent setSourceUtcTimestamp(OffsetDateTime sourceUtcTimestamp) {
