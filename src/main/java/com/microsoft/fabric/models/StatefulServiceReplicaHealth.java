...
/**
 * Represents the health of the stateful service replica. Contains the replica aggregated health state, the health
...
public final class StatefulServiceReplicaHealth extends ReplicaHealth {
     ...
     */
    public StatefulServiceReplicaHealth setReplicaId(String replicaId) {
