...
@JsonTypeName("StatelessReplicaHealthReportExpired")
@Fluent
public final class StatelessReplicaHealthReportExpiredEvent extends ReplicaEvent {
    /*
     * Id of report source.
     */
     ...
     * @return the StatelessReplicaHealthReportExpiredEvent object itself.
     */
    public StatelessReplicaHealthReportExpiredEvent setSourceId(String sourceId) {
     ...
     * @return the StatelessReplicaHealthReportExpiredEvent object itself.
     */
    public StatelessReplicaHealthReportExpiredEvent setProperty(String property) {
     ...
     * @return the StatelessReplicaHealthReportExpiredEvent object itself.
     */
    public StatelessReplicaHealthReportExpiredEvent setHealthState(String healthState) {
     ...
     * @return the StatelessReplicaHealthReportExpiredEvent object itself.
     */
    public StatelessReplicaHealthReportExpiredEvent setTimeToLiveMs(long timeToLiveMs) {
     ...
     * @return the StatelessReplicaHealthReportExpiredEvent object itself.
     */
    public StatelessReplicaHealthReportExpiredEvent setSequenceNumber(long sequenceNumber) {
     ...
     * @return the StatelessReplicaHealthReportExpiredEvent object itself.
     */
    public StatelessReplicaHealthReportExpiredEvent setDescription(String description) {
     ...
     * @return the StatelessReplicaHealthReportExpiredEvent object itself.
     */
    public StatelessReplicaHealthReportExpiredEvent setRemoveWhenExpired(boolean removeWhenExpired) {
     ...
     * @return the StatelessReplicaHealthReportExpiredEvent object itself.
     */
    public StatelessReplicaHealthReportExpiredEvent setSourceUtcTimestamp(OffsetDateTime sourceUtcTimestamp) {
