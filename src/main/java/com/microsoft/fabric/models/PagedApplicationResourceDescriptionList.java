...
/**
 * The list of application resources. The list is paged when all of the results cannot fit in a single message. The next
 * set of results can be obtained by executing the same query with the continuation token provided in this list.
 */
@Fluent
public final class PagedApplicationResourceDescriptionList {
    /*
    ...
    private List<ApplicationResourceDescription> items;
     ...
     * @return the PagedApplicationResourceDescriptionList object itself.
     */
    public PagedApplicationResourceDescriptionList setContinuationToken(String continuationToken) {
     ...
     * @return the PagedApplicationResourceDescriptionList object itself.
     */
    public PagedApplicationResourceDescriptionList setItems(List<ApplicationResourceDescription> items) {
        this.items = items;
        return this;
    }
}
