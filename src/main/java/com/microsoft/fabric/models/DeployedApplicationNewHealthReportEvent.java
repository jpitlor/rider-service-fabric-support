...
@JsonTypeName("DeployedApplicationNewHealthReport")
@Fluent
public final class DeployedApplicationNewHealthReportEvent extends ApplicationEvent {
    /*
     ...
     * @return the DeployedApplicationNewHealthReportEvent object itself.
     */
    public DeployedApplicationNewHealthReportEvent setApplicationInstanceId(long applicationInstanceId) {
     ...
     * @return the DeployedApplicationNewHealthReportEvent object itself.
     */
    public DeployedApplicationNewHealthReportEvent setNodeName(String nodeName) {
     ...
     * @return the DeployedApplicationNewHealthReportEvent object itself.
     */
    public DeployedApplicationNewHealthReportEvent setSourceId(String sourceId) {
     ...
     * @return the DeployedApplicationNewHealthReportEvent object itself.
     */
    public DeployedApplicationNewHealthReportEvent setProperty(String property) {
     ...
     * @return the DeployedApplicationNewHealthReportEvent object itself.
     */
    public DeployedApplicationNewHealthReportEvent setHealthState(String healthState) {
     ...
     * @return the DeployedApplicationNewHealthReportEvent object itself.
     */
    public DeployedApplicationNewHealthReportEvent setTimeToLiveMs(long timeToLiveMs) {
     ...
     * @return the DeployedApplicationNewHealthReportEvent object itself.
     */
    public DeployedApplicationNewHealthReportEvent setSequenceNumber(long sequenceNumber) {
     ...
     * @return the DeployedApplicationNewHealthReportEvent object itself.
     */
    public DeployedApplicationNewHealthReportEvent setDescription(String description) {
     ...
     * @return the DeployedApplicationNewHealthReportEvent object itself.
     */
    public DeployedApplicationNewHealthReportEvent setRemoveWhenExpired(boolean removeWhenExpired) {
     ...
     * @return the DeployedApplicationNewHealthReportEvent object itself.
     */
    public DeployedApplicationNewHealthReportEvent setSourceUtcTimestamp(OffsetDateTime sourceUtcTimestamp) {
