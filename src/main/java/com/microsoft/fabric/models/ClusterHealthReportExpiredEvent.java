...
@JsonTypeName("ClusterHealthReportExpired")
@Fluent
public final class ClusterHealthReportExpiredEvent extends ClusterEvent {
    /*
     * Id of report source.
     */
     ...
     * @return the ClusterHealthReportExpiredEvent object itself.
     */
    public ClusterHealthReportExpiredEvent setSourceId(String sourceId) {
     ...
     * @return the ClusterHealthReportExpiredEvent object itself.
     */
    public ClusterHealthReportExpiredEvent setProperty(String property) {
     ...
     * @return the ClusterHealthReportExpiredEvent object itself.
     */
    public ClusterHealthReportExpiredEvent setHealthState(String healthState) {
     ...
     * @return the ClusterHealthReportExpiredEvent object itself.
     */
    public ClusterHealthReportExpiredEvent setTimeToLiveMs(long timeToLiveMs) {
     ...
     * @return the ClusterHealthReportExpiredEvent object itself.
     */
    public ClusterHealthReportExpiredEvent setSequenceNumber(long sequenceNumber) {
     ...
     * @return the ClusterHealthReportExpiredEvent object itself.
     */
    public ClusterHealthReportExpiredEvent setDescription(String description) {
     ...
     * @return the ClusterHealthReportExpiredEvent object itself.
     */
    public ClusterHealthReportExpiredEvent setRemoveWhenExpired(boolean removeWhenExpired) {
     ...
     * @return the ClusterHealthReportExpiredEvent object itself.
     */
    public ClusterHealthReportExpiredEvent setSourceUtcTimestamp(OffsetDateTime sourceUtcTimestamp) {
