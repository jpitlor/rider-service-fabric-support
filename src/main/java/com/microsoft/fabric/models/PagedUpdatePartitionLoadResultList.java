...
/**
 * The list of results of the call UpdatePartitionLoad. The list is paged when all of the results cannot fit in a single
 * message. The next set of results can be obtained by executing the same query with the continuation token provided in
 * this list.
 */
@Fluent
public final class PagedUpdatePartitionLoadResultList {
    /*
    ...
    private List<UpdatePartitionLoadResult> items;
     ...
     * @return the PagedUpdatePartitionLoadResultList object itself.
     */
    public PagedUpdatePartitionLoadResultList setContinuationToken(String continuationToken) {
        this.continuationToken = continuationToken;
        return this;
    }

    /**
     * Get the items property: List of partition load update information.
     *
     * @return the items value.
     */
    public List<UpdatePartitionLoadResult> getItems() {
        return this.items;
    }

    /**
     * Set the items property: List of partition load update information.
     *
     * @param items the items value to set.
     * @return the PagedUpdatePartitionLoadResultList object itself.
     */
    public PagedUpdatePartitionLoadResultList setItems(List<UpdatePartitionLoadResult> items) {
        this.items = items;
        return this;
    }
}
