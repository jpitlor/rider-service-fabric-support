...
@JsonTypeName("ClusterUpgradeRollbackStarted")
@Fluent
public final class ClusterUpgradeRollbackStartedEvent extends ClusterEvent {
    /*
     ...
     * @return the ClusterUpgradeRollbackStartedEvent object itself.
     */
    public ClusterUpgradeRollbackStartedEvent setTargetClusterVersion(String targetClusterVersion) {
     ...
     * @return the ClusterUpgradeRollbackStartedEvent object itself.
     */
    public ClusterUpgradeRollbackStartedEvent setFailureReason(String failureReason) {
     ...
     * @return the ClusterUpgradeRollbackStartedEvent object itself.
     */
    public ClusterUpgradeRollbackStartedEvent setOverallUpgradeElapsedTimeInMs(double overallUpgradeElapsedTimeInMs) {
