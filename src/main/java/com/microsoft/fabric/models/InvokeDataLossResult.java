...
@Fluent
public final class InvokeDataLossResult {
    /*
     ...
     */
    public InvokeDataLossResult setErrorCode(Integer errorCode) {
     ...
     * @return the InvokeDataLossResult object itself.
     */
    public InvokeDataLossResult setSelectedPartition(SelectedPartition selectedPartition) {
