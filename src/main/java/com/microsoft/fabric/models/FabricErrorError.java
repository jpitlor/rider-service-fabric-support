...
@Fluent
public final class FabricErrorError {
    /*
    ...
    /**
     * Get the code property: Defines the fabric error codes that be returned as part of the error object in response to
     * Service Fabric API operations that are not successful. Following are the error code values that can be returned
     * for a specific HTTP status code.
     *
     * <p>- Possible values of the error code for HTTP status code 400 (Bad Request) - "FABRIC_E_INVALID_PARTITION_KEY"
     * - "FABRIC_E_IMAGEBUILDER_VALIDATION_ERROR" - "FABRIC_E_INVALID_ADDRESS" - "FABRIC_E_APPLICATION_NOT_UPGRADING" -
     * "FABRIC_E_APPLICATION_UPGRADE_VALIDATION_ERROR" - "FABRIC_E_FABRIC_NOT_UPGRADING" -
     * "FABRIC_E_FABRIC_UPGRADE_VALIDATION_ERROR" - "FABRIC_E_INVALID_CONFIGURATION" - "FABRIC_E_INVALID_NAME_URI" -
     * "FABRIC_E_PATH_TOO_LONG" - "FABRIC_E_KEY_TOO_LARGE" - "FABRIC_E_SERVICE_AFFINITY_CHAIN_NOT_SUPPORTED" -
     * "FABRIC_E_INVALID_ATOMIC_GROUP" - "FABRIC_E_VALUE_EMPTY" - "FABRIC_E_BACKUP_IS_ENABLED" -
     ...
     *
     * <p>- Possible values of the error code for HTTP status code 404 (Not Found) - "FABRIC_E_NODE_NOT_FOUND" -
     * "FABRIC_E_APPLICATION_TYPE_NOT_FOUND" - "FABRIC_E_APPLICATION_NOT_FOUND" - "FABRIC_E_SERVICE_TYPE_NOT_FOUND" -
     * "FABRIC_E_SERVICE_DOES_NOT_EXIST" - "FABRIC_E_SERVICE_TYPE_TEMPLATE_NOT_FOUND" -
     ...
     * "FABRIC_E_FAULT_ANALYSIS_SERVICE_NOT_EXISTING" - "FABRIC_E_IMAGEBUILDER_RESERVED_DIRECTORY_ERROR"
     *
     * <p>- Possible values of the error code for HTTP status code 409 (Conflict) -
     ...
     * "FABRIC_E_NODE_HAS_NOT_STOPPED_YET" - "FABRIC_E_INSTANCE_ID_MISMATCH" - "FABRIC_E_BACKUP_IN_PROGRESS" -
     * "FABRIC_E_RESTORE_IN_PROGRESS" - "FABRIC_E_BACKUP_POLICY_ALREADY_EXISTING"
     *
     * <p>- Possible values of the error code for HTTP status code 413 (Request Entity Too Large) -
     * "FABRIC_E_VALUE_TOO_LARGE"
     *
     * <p>- Possible values of the error code for HTTP status code 500 (Internal Server Error) - "FABRIC_E_NODE_IS_UP" -
     * "E_FAIL" - "FABRIC_E_SINGLE_INSTANCE_APPLICATION_ALREADY_EXISTS" -
     * "FABRIC_E_SINGLE_INSTANCE_APPLICATION_NOT_FOUND" - "FABRIC_E_VOLUME_ALREADY_EXISTS" - "FABRIC_E_VOLUME_NOT_FOUND"
     * - "SerializationError"
     *
     * <p>- Possible values of the error code for HTTP status code 503 (Service Unavailable) -
     * "FABRIC_E_NO_WRITE_QUORUM" - "FABRIC_E_NOT_PRIMARY" - "FABRIC_E_NOT_READY" - "FABRIC_E_RECONFIGURATION_PENDING" -
     * "FABRIC_E_SERVICE_OFFLINE" - "E_ABORT" - "FABRIC_E_VALUE_TOO_LARGE"
     *
     * <p>- Possible values of the error code for HTTP status code 504 (Gateway Timeout) -
    ...
    /**
     * Set the code property: Defines the fabric error codes that be returned as part of the error object in response to
     * Service Fabric API operations that are not successful. Following are the error code values that can be returned
     * for a specific HTTP status code.
     *
     * <p>- Possible values of the error code for HTTP status code 400 (Bad Request) - "FABRIC_E_INVALID_PARTITION_KEY"
     ...
     */
    public FabricErrorError setCode(FabricErrorCodes code) {
        this.code = code;
        return this;
    }
     ...
     * @return the FabricErrorError object itself.
     */
    public FabricErrorError setMessage(String message) {
