...
@JsonTypeName("StatelessReplicaNewHealthReport")
@Fluent
public final class StatelessReplicaNewHealthReportEvent extends ReplicaEvent {
    /*
     * Id of report source.
     */
     ...
     * @return the StatelessReplicaNewHealthReportEvent object itself.
     */
    public StatelessReplicaNewHealthReportEvent setSourceId(String sourceId) {
     ...
     * @return the StatelessReplicaNewHealthReportEvent object itself.
     */
    public StatelessReplicaNewHealthReportEvent setProperty(String property) {
     ...
     * @return the StatelessReplicaNewHealthReportEvent object itself.
     */
    public StatelessReplicaNewHealthReportEvent setHealthState(String healthState) {
     ...
     * @return the StatelessReplicaNewHealthReportEvent object itself.
     */
    public StatelessReplicaNewHealthReportEvent setTimeToLiveMs(long timeToLiveMs) {
     ...
     * @return the StatelessReplicaNewHealthReportEvent object itself.
     */
    public StatelessReplicaNewHealthReportEvent setSequenceNumber(long sequenceNumber) {
     ...
     * @return the StatelessReplicaNewHealthReportEvent object itself.
     */
    public StatelessReplicaNewHealthReportEvent setDescription(String description) {
     ...
     * @return the StatelessReplicaNewHealthReportEvent object itself.
     */
    public StatelessReplicaNewHealthReportEvent setRemoveWhenExpired(boolean removeWhenExpired) {
     ...
     * @return the StatelessReplicaNewHealthReportEvent object itself.
     */
    public StatelessReplicaNewHealthReportEvent setSourceUtcTimestamp(OffsetDateTime sourceUtcTimestamp) {
