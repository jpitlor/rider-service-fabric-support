...
@JsonTypeName("NodeAddedToCluster")
@Fluent
public final class NodeAddedToClusterEvent extends NodeEvent {
    /*
     * Id of Node.
     */
     ...
     * @return the NodeAddedToClusterEvent object itself.
     */
    public NodeAddedToClusterEvent setNodeId(String nodeId) {
        this.nodeId = nodeId;
        return this;
    }
     ...
     * @return the NodeAddedToClusterEvent object itself.
     */
    public NodeAddedToClusterEvent setNodeInstance(long nodeInstance) {
     ...
     * @return the NodeAddedToClusterEvent object itself.
     */
    public NodeAddedToClusterEvent setNodeType(String nodeType) {
     ...
     * @return the NodeAddedToClusterEvent object itself.
     */
    public NodeAddedToClusterEvent setFabricVersion(String fabricVersion) {
     ...
     * @return the NodeAddedToClusterEvent object itself.
     */
    public NodeAddedToClusterEvent setIpAddressOrFqdn(String ipAddressOrFqdn) {
     ...
     * @return the NodeAddedToClusterEvent object itself.
     */
    public NodeAddedToClusterEvent setNodeCapacities(String nodeCapacities) {
